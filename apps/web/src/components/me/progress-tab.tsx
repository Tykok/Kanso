 ...
 * puts the verdict into words. It also made a ruling that must not be silently
 * contradicted: median cycle time is absent on purpose, waiting on the `activity`
